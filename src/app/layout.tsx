...
export const metadata: Metadata = {
  ...
  // ✅ 1. كود التفعيل الخاص بجوجل (اللي إنت بعته)
  verification: {
    google: 'nVxOxzZbIM5NOMJe2Qt7z0PyVF1_3mSXENCni1ZS1UE',
  },

  // 2. إعدادات العنوان والوصف (عشان تظهر بشياكة في البحث)
  title: {
    default: 'كودا | شريكك التقني للتجارة الإلكترونية',
    template: '%s | كودا',
  },
  description:
    'امتلك متجرك الإلكتروني بملكية كاملة و 0% عمولة. كودا بتقدم حلول شوبيفاي، ووردبريس،ايزي اورد، وبرمجة خاصة، مع ربط فوري بشركات الشحن والدفع في مصر.',
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/og-image.png', // اتأكد إنك حطيت صورة بالاسم ده في فولدر public
        width: 1200,
        height: 630,
